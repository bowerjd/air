...
public class BsonPostProcessorImpl implements SlingPostProcessor {
    ...
    private Set<String> findAuthoredBsonResources(Resource resource, String property) {
        ...
        ModifiableValueMap properties = modifiableValueMap(resource);
    ...
    private Set<String> findExistingBsonResources(Resource resource, String property) {
        ...
        while (children.hasNext()) {
            ...
            ModifiableValueMap properties = modifiableValueMap(child);
    ...
    private ModifiableValueMap modifiableValueMap(Resource r) {
        ModifiableValueMap ret = r.adaptTo(ModifiableValueMap.class);
        if (ret == null) {
            throw new NullPointerException(format("Failed to adapt resource to %s", ModifiableValueMap.class.getSimpleName()));
        }
        return ret;
    }
